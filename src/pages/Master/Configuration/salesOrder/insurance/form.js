        ...
        <div className="container-fluid">
            <div className="row">
                <div className="col-md-4">
                    <TextField label="Insurance ID" name="insurance_id" value={groupValues.insurance_id} onChange={handleOnChange} fullWidth variant="outlined" size="small" />
                </div>
                <div className="col-md-4">
                    <TextField label="Insurance Name" name="insurance_name" value={groupValues.insurance_name} onChange={handleOnChange} fullWidth variant="outlined" size="small" />
                </div>
                <div className="col-md-4">
