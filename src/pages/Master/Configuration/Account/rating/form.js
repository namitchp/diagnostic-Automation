        ...
        <div className="container-fluid">
            <div className="row">
                <div className="col-md-4">
                    <TextField label="Rating ID" name="rating_id" value={groupValues.rating_id} onChange={handleOnChange} fullWidth variant="outlined" size="small" />
                </div>
                <div className="col-md-4">
                    <TextField label="Rating Name" name="group_name" value={groupValues.rating_name} onChange={handleOnChange} fullWidth variant="outlined" size="small" />
                </div>
                <div className="col-md-4">
